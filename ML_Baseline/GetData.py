...
class Preprocessor_ML():
    ...
    def Work(self, mode='merge_raw', ToObjectColumn='Ignore', SeparateTrainData=True):
        ...
        if mode == 'merge_raw':
            ...
            #only use transaction data in R-GCN
            ...
            Raw_data = pd.merge(self.train_transaction, self.train_identity, on='TransactionID', how='left')
            cols_lotof_nulls = self.GetColNull(0.90)
